...
<html lang="en">
	<head>
		...
		<title>Electro Ecommerce Shop</title>
			...
			<div id="top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						...
						@else
							<li>
								<a href="{{ route('register') }}"><i class="fa fa-user-o"></i> My Account</a>
							</li>
						@endauth
						@endif
						<li>
							<a href="{{ route('myorder') }}">
								<i class="fa fa-group"></i>My Order
							</a>
						</li>
					</ul>
				</div>
										...
										<div class="cart-list">
											...
											<div class="product-widget">
												...
												<div class="product-body">
													<h3 class="product-name"><a href="#">{{ $cart->product->title }}</a></h3>
													<h4 class="product-price"><span class="qty">1x</span>${{ $cart->product->price }}</h4>
												</div>
												<a href="{{ route('product_delete',$cart->id) }}">
