          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-bs-toggle="dropdown" aria-expanded="false" href="#">+ Add eCommerce </a>
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                        <form action="{{ route('logout') }}" method="post">
                            @csrf
                            <p class="admin-logout"><input type="submit" value="Logout" class="preview-subject mt-1 mb-1"></p>
                        </form>
